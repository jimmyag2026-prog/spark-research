...
| 5 | 09-15 22:06 | 问「RSI 中美进展」（session `web_1789480157513`，选择器选了 kimi-k2.6） | 拿到综述 | 流程在跑：检索 21:51 完成，精读每篇 ~50s；界面无进度让人以为卡死 | → U49 U50 已修（等任务跑完再重启生效） |
...
| 09-16 00:07 | 「结论说未记录阅读卡片与综述工件 ID，为什么」（session `web_1789482658926`，v0.9.1） | 卡 8 张、artifact 545eef26… 都在，summarize 只收到 629 字符 | ✅ U57 已修（我上一轮 U48 的 600 上限误伤） |

| 09-16 00:28 | 「中文文献也可以搜索和下载吗」 | 实测中文查询 74 条命中、0 条相关；CNKI/万方占位 | → U58（并入 v0.10 γ-2） |
